...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in p4/server/v1/config_pb2_grpc.py depends on'
...
def add_ServerConfigServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('p4.server.v1.ServerConfig', rpc_method_handlers)
